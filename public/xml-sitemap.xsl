		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<!--<p class="expl">-->
						<!--Generated by <a href="http://yoast.com/">Yoast</a>'s <a href="http://yoast.com/xml-sitemap-php-script/">XML Sitemap PHP Script</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>-->
