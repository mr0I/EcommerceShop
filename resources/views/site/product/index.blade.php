    ...
    <div class="cart-inner">
      ...
      <form class="theme-form">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="review" placeholder="رمز عبور خود را وارد کنید" required="">
        </div>
        <div class="form-group">
                    ...
                    <div class="row" id="upsell_product">
                      <div class="product-box col-sm-3 col-6">
                        <div class="img-wrapper">
                          <div class="front">
                            <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/layout-4/product/1.jpg" class="img-fluid blur-up lazyload mb-1"
                                   alt="cotton top">
                            </a>
                          </div>
                      ...
                      <div class="product-box col-sm-3 col-6">
                        <div class="img-wrapper">
                          <div class="front">
                            <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/layout-4/product/2.jpg" class="img-fluid blur-up lazyload mb-1"
                                   alt="cotton top">
                            </a>
                          </div>
                          <div class="product-detail">
            ...
            <div class="col-lg-6 rtl-text">
              <div class="product-right">
                ...
                <div class="pro-group pb-0">
                  <h6 class="product-title size-text">انتخاب سایز</h6>
                  <div class="size-box">
                    <ul>
                      <li><a href="javascript:void(0)">s</a></li>
                      <li><a href="javascript:void(0)">m</a></li>
                  ...
                  <div class="product-buttons">
                    <a href="javascript:void(0)" onclick="openCart()" class="btn cart-btn btn-normal tooltip-top"
                       data-tippy-content="افزودن به سبد خرید">
                      <i class="fa fa-shopping-cart"></i>
                      افزودن به سبد خرید
                    </a>
