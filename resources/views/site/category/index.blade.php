            ...
            <div class="col-sm-3 collection-filter category-page-side">
              ...
              <div class="theme-card creative-card creative-inner">
                ...
                <div class="slide-1">
                  ...
                  @endif
                  @if(sizeof($latest_computer_parts_products) !== 0)
                    <div>
                      <div class="media-banner plrb-0 b-g-white1 border-0">
                  ...
                  @endif
                  @if(sizeof($latest_laptop_accessories_products) !== 0)
                    <div>
                      <div class="media-banner plrb-0 b-g-white1 border-0">
                  ...
                  @endif
                  @if(sizeof($latest_wearable_gadget_products) !== 0)
                    <div>
                      <div class="media-banner plrb-0 b-g-white1 border-0">
                  ...
                  @endif
                  @if(sizeof($latest_tablet_products) !== 0)
                    <div>
                      <div class="media-banner plrb-0 b-g-white1 border-0">
                  ...
                  @endif
                  @if(sizeof($latest_laptop_products) !== 0)
                    <div>
                      <div class="media-banner plrb-0 b-g-white1 border-0">
                  ...
                  @endif
                  @if(sizeof($latest_office_machines_products) !== 0)
                    <div>
                      <div class="media-banner plrb-0 b-g-white1 border-0">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="top-banner-wrapper">
                        <img src="{{ url('/images/banner/shop_banner.webp') }}" class="img-fluid  w-100" alt="{{ __('Shop Banner') }}">
                    </div>
